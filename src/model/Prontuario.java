...
public class Prontuario {
    ...
    public Prontuario(int id, Date dataHoraVisita, String descricaoVisita, String observacao, String status, InternacaoLeito internacaoLeite, Enfermeiro enfermeiro, Medico medico, MovimentoMedicamento movimentoMedicamento) {
        this.id = id;
